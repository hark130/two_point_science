...
TPH_HOSPITAL_DICT = {
    ...
    Hospital_Details(illness=['8-bitten', 'Animal Magnetism', 'Cubism', 'Decision Rash',
    ...
    Hospital_Details(illness=[TPH_NAME_DISEASE_VD, 'Lazy Bones', 'Misery Guts', 'Mucky Feet',
    ...
    Hospital_Details(illness=['Grey Anatomy', 'Cross Bones', 'Humerus Injury', 'Hurty Leg',
...
TPH_ILLNESS_DICT = {
    ...
    'Animal Magnetism': Illness_Details(diagnostic=['Cardiology', 'M.E.G.A Scan'],
                                        treatment='Pest Control'),
    'Artificial Intelligence': Illness_Details(diagnostic=[TPH_NAME_ROOM_GP, 'Ward'],
    ...
    'Bogwarts': Illness_Details(diagnostic=['General Diagnosis', 'Cardiology'],
                                treatment='Pharmacy'),
    'Bone Head': Illness_Details(diagnostic=[TPH_NAME_ROOM_GP], treatment='Surgery'),
    'Broken Face': Illness_Details(diagnostic=['Cardiology', 'Fluid Analysis'],
    ...
    'Decision Rash': Illness_Details(diagnostic=['Fluid Analysis', 'Cardiology'],
                                     treatment='Injection Room'),
    'Denim Genes': Illness_Details(diagnostic=['Fluid Analysis', 'M.E.G.A Scan'],
                                   treatment='DNA Lab'),
    'Dino Sores': Illness_Details(diagnostic=[TPH_NAME_ROOM_GP], treatment='Injection Room'),
    'Emperor Complex': Illness_Details(diagnostic=['DNA Lab', 'Cardiology'],
                                       treatment='Psychiatry'),
    ...
    'Freudian Lips': Illness_Details(diagnostic=['Cardiology', 'Psychiatry'],
                                     treatment='Psychiatry'),
    'Grey Anatomy': Illness_Details(diagnostic=['Fluid Analysis', 'M.E.G.A Scan'],
                                    treatment='Chromatherapy'),
    'Grout': Illness_Details(diagnostic=[TPH_NAME_ROOM_GP], treatment='Pharmacy'),
    'Gurning Loins': Illness_Details(diagnostic=['General Diagnosis', 'M.E.G.A Scan'],
                                     treatment='Surgery'),
    'Headcrabedness': Illness_Details(diagnostic=[TPH_NAME_ROOM_GP], treatment='De-Lux Clinic'),
    'Heart Throb': Illness_Details(diagnostic=['Cardiology', 'Fluid Analysis'],
                                   treatment='Surgery'),
    'Hotheadedness': Illness_Details(diagnostic=[TPH_NAME_ROOM_GP], treatment='De-Lux Clinic'),
    'Humerus Injury': Illness_Details(diagnostic=['General Diagnosis', 'Ward'],
                                      treatment='Fracture Ward'),
    'Hurty Leg': Illness_Details(diagnostic=['General Diagnosis', 'X-Ray'],
                                 treatment='Fracture Ward'),
    'Inflated Ego': Illness_Details(diagnostic=['Fluid Analysis', 'General Diagnosis'],
                                    treatment='Psychiatry'),
    ...
    'Jumbo DNA': Illness_Details(diagnostic=['M.E.G.A Scan', 'Fluid Analysis'],
                                 treatment='DNA Lab'),
    'Lazy Bones': Illness_Details(diagnostic=['Cardiology', 'General Diagnosis'],
                                  treatment='Ward'),
    'Leopard Skin': Illness_Details(diagnostic=['Fluid Analysis', 'X-Ray'],
                                    treatment='DNA Lab'),
    'Lightheadedness': Illness_Details(diagnostic=['General Diagnosis', 'Cardiology'],
                                       treatment='De-Lux Clinic'),
    'Lightheadedness (Frightheadedness)': Illness_Details(diagnostic=['', ''],
                                                          treatment='De-Lux Clinic'),
    'Litter Bug': Illness_Details(diagnostic=['Fluid Analysis', 'X-Ray'],
                                  treatment='Injection Room'),
    'Loopy': Illness_Details(diagnostic=[TPH_NAME_ROOM_GP], treatment='Ward'),
    'Lycanthropy': Illness_Details(diagnostic=['Cardiology', 'Fluid Analysis'],
                                   treatment='Pharmacy'),
    'Mime Crisis': Illness_Details(diagnostic=['Cardiology', 'Psychiatry'], treatment='Psychiatry'),
    'Misery Guts': Illness_Details(diagnostic=['Cardiology', 'Fluid Analysis'],
                                   treatment='Pharmacy'),
    'Missing Link': Illness_Details(diagnostic=[TPH_NAME_ROOM_GP, 'M.E.G.A Scan'],
                                    treatment='Fracture Ward'),
    'Mock Star': Illness_Details(diagnostic=['General Diagnosis', 'Cardiology'],
                                 treatment='Psychiatry'),
    'Monobrow': Illness_Details(diagnostic=['Ward', 'X-Ray'], treatment='Ward'),
    'Mood Poisoning': Illness_Details(diagnostic=['General Diagnosis', 'Cardiology'],
                                      treatment='Injection Room'),
    'Mucky Feet': Illness_Details(diagnostic=['DNA Lab', 'X-Ray'], treatment='Ward'),
    'Night Fever': Illness_Details(diagnostic=['General Diagnosis', 'Psychiatry'],
                                   treatment='Psychiatry'),
    ...
    TPH_NAME_DISEASE_PM: Illness_Details(diagnostic=['Psychiatry', 'X-Ray'],
                                         treatment=TPH_NAME_ROOM_CR),
    'Pudding Blood': Illness_Details(diagnostic=['Psychiatry', 'X-Ray'],
                                     treatment='Injection Room'),
    'Reptile Dysfunction': Illness_Details(diagnostic=[TPH_NAME_ROOM_GP], treatment='Psychiatry'),
    'Rock Bottom': Illness_Details(diagnostic=['Fluid Analysis', 'DNA Lab'],
                                   treatment='Injection Room'),
    ...
    'Shock Horror': Illness_Details(diagnostic=['Ward', 'Fluid Analysis'],
    ...
    'Spontaneous Combustion': Illness_Details(diagnostic=['M.E.G.A Scan', 'DNA Lab'],
                                              treatment='Injection Room'),
