...
TPH_ILLNESS_DICT = {
    ...
    TPH_NAME_DISEASE_BM: IllnessDetails(diagnostic=[TPH_NAME_ROOM_WA, TPH_NAME_ROOM_XR], treatment=TPH_NAME_ROOM_PSY, difficulty=0.6, death=MISSING_DATA, decline=0.1),
    ...
    TPH_NAME_DISEASE_CLA: IllnessDetails(diagnostic=[TPH_NAME_ROOM_GP, ], treatment=TPH_NAME_ROOM_PH, difficulty=0.1, death=MISSING_DATA, decline=0.75),
    ...
    TPH_NAME_DISEASE_EC: IllnessDetails(diagnostic=[TPH_NAME_ROOM_DL, TPH_NAME_ROOM_CA], treatment=TPH_NAME_ROOM_PSY, difficulty=0.7, death=MISSING_DATA, decline=0.1),
    ...
    TPH_NAME_DISEASE_FL: IllnessDetails(diagnostic=[TPH_NAME_ROOM_CA, TPH_NAME_ROOM_PSY], treatment=TPH_NAME_ROOM_PSY, difficulty=0.3, death=MISSING_DATA, decline=0.1),
    ...
    TPH_NAME_DISEASE_GA: IllnessDetails(diagnostic=[TPH_NAME_ROOM_FA, TPH_NAME_ROOM_MS], treatment=TPH_NAME_ROOM_CH, difficulty=0.4, death=MISSING_DATA, decline=0.75),
    TPH_NAME_DISEASE_GR: IllnessDetails(diagnostic=[TPH_NAME_ROOM_GP, ], treatment=TPH_NAME_ROOM_PH, difficulty=0, death=MISSING_DATA, decline=0.5),
    ...
    TPH_NAME_DISEASE_IE: IllnessDetails(diagnostic=[TPH_NAME_ROOM_FA, TPH_NAME_ROOM_GD], treatment=TPH_NAME_ROOM_PSY, difficulty=0.5, death=MISSING_DATA, decline=0.1),
    ...
    TPH_NAME_DISEASE_JI: IllnessDetails(diagnostic=[TPH_NAME_ROOM_PSY, TPH_NAME_ROOM_XR], treatment=TPH_NAME_ROOM_CL, difficulty=0.4, death=MISSING_DATA, decline=0.1),
    ...
    TPH_NAME_DISEASE_MC: IllnessDetails(diagnostic=[TPH_NAME_ROOM_CA, TPH_NAME_ROOM_PSY], treatment=TPH_NAME_ROOM_PSY, difficulty=0.4, death=MISSING_DATA, decline=0.1),
    ...
    TPH_NAME_DISEASE_MS: IllnessDetails(diagnostic=[TPH_NAME_ROOM_GD, TPH_NAME_ROOM_CA], treatment=TPH_NAME_ROOM_PSY, difficulty=0.2, death=MISSING_DATA, decline=0.1),
    ...
    TPH_NAME_DISEASE_NF: IllnessDetails(diagnostic=[TPH_NAME_ROOM_GD, TPH_NAME_ROOM_PSY], treatment=TPH_NAME_ROOM_PSY, difficulty=0.5, death=MISSING_DATA, decline=0.1),
